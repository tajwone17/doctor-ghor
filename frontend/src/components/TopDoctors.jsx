...
const TopDoctors = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      ...
      <button onClick={() => navigate("/doctors")} className="bg-green-50 text-green-700 px-12 py-3 rounded-full mt-10 border border-green-700 cursor-pointer hover:bg-green-100"> See more</button>
    </div>
  );
};
