              ...
              <div className="absolute -bottom-16 left-8">
                <div className="relative">
                  <label htmlFor="image" className="cursor-pointer">
                    ...
                    />
                    {isEdit && (
                      <div className="absolute bottom-0 right-0 bg-primary hover:bg-blue-600 text-white rounded-full p-2 shadow-lg transition-colors">
                        <svg
                ...
                {isEdit ? (
                  <>
                    ...
                    <button
                      ...
                      className="px-6 py-2 bg-primary text-white rounded-lg hover:bg-blue-600 transition-all font-medium shadow-md hover:shadow-lg"
                    >
                      Save Changes
                    </button>
                  </>
